...
export class Scrub<T>{
    ...
    public forEach(action: (value: any, key: string) => boolean | void) {
        _.forEach(this.valid, (value: T, key: string) => {
            try {
    ...
    public failAction<TActionReturn>(action: () => TActionReturn): TActionReturn | null {
        if (this.isValid) {
            return null;
        }
        return action();
    ...
    public isTemplatePopulated(template: {}, errorMessage?: string, printInvalidValues = true): Scrub<T> {
        ...
        _.forEach(template, (templateValue: any, key: string) => {
    ...
    public getValid<U>(key: string, valueIfUndefined: U): U;
    getValid<U>(key: string, valueIfUndefined?: U): any {
...
export function isTemplatePopulated<TTemplate>(input: {}, /** required values that must exist in the input, and of the right type */ template: {}): { valid: boolean, invalidMessage?: string } {

    function nodeLoop(inputTargetNode: any, templateTargetNode: any, key: string, nodeChain: string): { valid: boolean, invalidMessage?: string } {
        ...
        let tempNodeResult: { valid: boolean, invalidMessage?: string } | null = null;
        _.forEach(templateTargetNode, (nextValue: any, nextKey: string) => {
...
export function scrubUserInput<TOutput extends {}, TRequiredValues extends {}, TDefaultValues extends {}>(
    untrustedUserInput: string | Buffer | Promise<string | Buffer> | {},
    requiredValues: TRequiredValues,
    defaultValues: TDefaultValues = {} as any, options: serialization.ITemplateParseOptions = {}): TRequiredValues & TDefaultValues {
