...
declare module "node-forge" {
    ...
    namespace pki {
        ...
        function certificateFromPem(certPem:PEM):Certificate;
        function privateKeyFromPem(certPem:PEM):Key;
        ...
        interface Certificate {
            ...
            publicKey: any;
            md: any;
//JASON-EDIT: missing signatures
            setSubject(CAattrs:{name?:string;shortName?:string; value:string;}[]);
            setIssuer(CAattrs:{name?:string;shortName?:string; value:string;}[]);
            setExtensions(args:any);
            sign(privateKey:any, algorithm:any );
        }
